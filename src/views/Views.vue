<template>
    <div class='views'>
        ...
        <ul class='videos'>
            <li><iframe width="340" height="192" src="https://www.youtube.com/embed/14O7AxqjiVY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></li>
